  ...
  <nav class="w-full bg-white border-solid border-b relative">
    <div class="container max-w-screen-lg">
      <ul class="text-sm font-light text-primary flex items-center mb-4">
        ...
        <li class="mr-6 hover:text-black transition ease-in-out duration-300"><a href="#">Activity</a></li>
        <li class="mr-6 hover:text-black transition ease-in-out duration-300"><a href="#">Domains</a></li>
